...
public class AuthorType : ObjectType<AoutherEntity>
{

    protected override void Configure(IObjectTypeDescriptor<AoutherEntity> descriptor)
    {
...
public class ContentType : ObjectType<ContentEntity>
{
    ...
    protected override void Configure(IObjectTypeDescriptor<ContentEntity> descriptor)
    {
        ...
        descriptor.Field(c => c.ProgramDetails).Type<ListType<ProgramDetailsItemType>>();
    }

}


public class ProgramDetailsItemType : ObjectType<ProgramDetailItemEntity>
{
